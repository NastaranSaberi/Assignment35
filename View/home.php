...
<div class="container-fluid mt-3">
    <div class="row row_home">
        ...
        <div class="col-lg-5 shadow-sm col_add_post">
            <form method="post" action="post_process" id="form_new_post">
                <div class="row row_add_post"   >
                    <div class="text-center ">
                        <h4 style="display: inline-block;">Create post</h4>
                        <hr>
                    </div>
                    <!--                 
                    <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-lg-12">
                            <div class="input-group mt-3">
                                <input class=" mt-1 text-light input_caption" name="caption" type="text" placeholder="what's on your mind ?" >
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="input-group mt-3">
                        ...
                        <div class="btn_center">
                            <button form="form_new_post" class="mt-3 mb-3 btn_submit_add_post" type="submit" class="btn btn-primary" >submit</button>
                        </div>
                </div>
            </form>
        ...
        <div class="row justify-content-center mt-5" style="padding: 0px;">
            ...
            <div class="col-lg-5  shadow-sm col_others_post">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-2">
                            <img src="View/Images/1be62af92478f388bcd15708dab2c93a.jpeg" class="mt-1 username_post" alt="" height="40px" width="40px" style="border-radius:50%;">
                        </div>
                ...
                <div>
                    <img src="<?php echo $post["media"]; ?>" class="card-img-top"  alt="..." height="500px" width="500px" >
                </div>
                <div>
                ...
                <div>
                    <p class="text-end mt-3">1.4K Comments 1K Shares</p>
                </div>
                <hr>
                <div class="footer">
                    <div class="row mt-3 mb-3" style="text-center">
                        <div class="col text-center">
                            <i data-visualcompletion="css-img" class="hu5pjgll m6k467ps i_posts" style="background-image: url(&quot;https://static.xx.fbcdn.net/rsrc.php/v3/yf/r/qXc5MlTH_R6.png&quot;); background-position: 0px -297px; background-size: 25px 770px; width: 18px; height: 18px; background-repeat: no-repeat; display: inline-block;-webkit-filter:invert(62%) sepia(98%) saturate(12%) hue-rotate(175deg) brightness(90%) contrast(96%);"></i>
                            <span style="font-weight: 700;">Like</span>
                        </div>
                        <div class="col text-center">
                            <i data-visualcompletion="css-img" class="hu5pjgll m6k467ps" style="background-image: url(&quot;https://static.xx.fbcdn.net/rsrc.php/v3/yf/r/qXc5MlTH_R6.png&quot;); background-position: 0px -259px; background-size: 25px 770px; width: 18px; height: 18px; background-repeat: no-repeat; display: inline-block;-webkit-filter:invert(62%) sepia(98%) saturate(12%) hue-rotate(175deg) brightness(90%) contrast(96%);"></i>
                            <span style="font-weight: 700;">Cm</span>
                        </div>
                        <div class="col text-center">
                            <i data-visualcompletion="css-img" style="background-image: url(&quot;https://static.xx.fbcdn.net/rsrc.php/v3/yf/r/qXc5MlTH_R6.png&quot;); background-position: 0px -316px; background-size: 25px 770px; width: 18px; height: 18px; background-repeat: no-repeat; display: inline-block;-webkit-filter:invert(62%) sepia(98%) saturate(12%) hue-rotate(175deg) brightness(90%) contrast(96%);"></i>
